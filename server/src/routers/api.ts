...
apiRoutes.get('/departures/:id', DeparturesController.getDepartures);
...
apiRoutes.get('/connection-prices/:id', ConnectionPricesController.getConnectionPrice);
apiRoutes.post('/connection-prices', ConnectionPricesController.insertConnectionPrice);
apiRoutes.put('/connection-prices/:id', checkPrivileges('bus_connections', 'owner_id'), ConnectionPricesController.updateConnectionPrice);
apiRoutes.delete('/connection-prices/:id', checkPrivileges('bus_connections', 'owner_id'), ConnectionPricesController.deleteConnectionPrice);
...
apiRoutes.post('/connections', ConnectionsController.insertConnection);
...
apiRoutes.get('/bus-stops/:id', BusStopsController.getBusStops);
